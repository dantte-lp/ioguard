 ...
 */
typedef ssize_t (*rw_conn_data_read_fn)(void *ctx, void *buf, size_t len);
typedef ssize_t (*rw_conn_data_write_fn)(void *ctx, const void *buf, size_t len);
...
typedef struct {
    ...
    rw_conn_data_read_fn tls_read;
    rw_conn_data_write_fn tls_write;
    void *tls_ctx;
